...
public class FileOperate
{
	 ...
	 * @throws IOException
	 */
	public String writeToSdcard(String name , String content ) throws IOException
	{
		// 获取SDcard的根目录
...
//			MyUtil.showMsg(context ,file.toString() ,2);
			// 创建输出流对象
		...
		{
			// MyUtil.showMsg(context
			// ,context.getString(R.string.sdcard_error));
			MyUtil.showMsg(context ,"SDCard不存在或不是可读写状态!" ,1);
			return null;
		}
	}
}
